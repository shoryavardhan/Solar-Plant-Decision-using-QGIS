...
with open('/home/mannu/Desktop/test.csv', 'r') as csvFile:
...
with open('/home/mannu/Desktop/fuzzy.csv', 'w') as ccvFile:
    reader = csv.reader(open('/home/mannu/Desktop/test.csv', 'r'), dialect='myDialect')
    for row in reader:
        for i in range (1,6):
            write[0]=row[0]
...
i=0
r=0
with open('/home/mannu/Desktop/test.csv', 'w') as ccfFile:
    reader = csv.reader(open('/home/mannu/Desktop/fuzzy.csv', 'r'), dialect='myDialect')
    for row in reader:
        si=0.0
        for i in range (1,5):
            #print(row[i])
    ...
    with open('/home/mannu/Desktop/pyAHP-master/tentotwo.csv', 'w') as ccvfile2:
        with open('/home/mannu/Desktop/pyAHP-master/twotoend.csv', 'w') as ccvfile3:
            ...
            for row in reader:
                ...
                k=k+1        
'''  
uri = "file:///home/mannu/Desktop/pyAHP-master/finalish.csv?type=csv&delimiter=;&quote=&escape=&detectTypes=yes&xField=Long&yField=Latt&crs=EPSG:4326&spatialIndex=no&subsetIndex=no&watchFile=no&yField=3"
vlayer = QgsVectorLayer(uri,'MultiPoints','delimitedtext')
...
''''''
uri1 = "file:///home/mannu/Desktop/pyAHP-master/topten.csv?type=csv&delimiter=;&quote=&escape=&detectTypes=yes&xField=Long&yField=Latt&crs=EPSG:4326&spatialIndex=no&subsetIndex=no&watchFile=no&yField=3"
